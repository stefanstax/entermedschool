	...
	<div class="header-aside-inner">
		...
		<?php else : ?>
			...
			<div class="bb-header-buttons">
				<a href="<?php echo home_url("/login"); ?>" class="button small outline signin-button link">Sign In</a>

				<?php if (!is_user_logged_in()) : ?>
					<a href="<?php echo home_url("/registration"); ?>" class="button small singup">Sign Up</a>
				<?php endif; ?>
			</div>
