...
if (is_page("imat")) {
    $args = array(
        'tag' => "imat-article", // Here is where is being filtered by the tag you want
        'orderby' => 'publish_date',
        'order' => 'DESC'
    );
} elseif (is_page("neet")) {
    $args = array(
        'tag' => "neet-article", // Here is where is being filtered by the tag you want
        'orderby' => 'publish_date',
        'order' => 'DESC'
    );
} elseif (is_page("bmat-exam")) {
    $args = array(
        'tag' => "bmat-article", // Here is where is being filtered by the tag you want
        'orderby' => 'publish_date',
        'order' => 'DESC'
    );
}
